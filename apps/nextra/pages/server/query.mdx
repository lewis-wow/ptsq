...
Likewise, if output validation fails, the `PtsqError` throws an `INTERNAL_SERVER_ERROR_500` error, including information about the validation error within the info property.

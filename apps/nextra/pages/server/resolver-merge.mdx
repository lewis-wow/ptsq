...
const deepContextChangeResolverOverwrite = Resolver.merge(
  resolver, // ctx = { a: { b: number } }
  deepContextChangeResolver, // ctx = { a: { c: number } }
);
...
const deepContextChangeResolverOverwrite = Resolver.merge(
  resolver, // ctx = { a: { b: number } }
  deepContextChangeResolver, // ctx = { a: { b: number; c: number } }
);
```

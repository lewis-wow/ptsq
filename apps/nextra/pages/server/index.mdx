...
The library provides listeners for HTTP servers created by external modules such as node:http, Express, Fastify, or Koa.

```ts copy filename="Create PTSQ server"
